...
class rzvy_categories{
	...
	public function add_category(){
        $catUrl = implode("-", $this->cat_name);
		$query = "INSERT INTO `".$this->rzvy_categories."` (`id`, `cat_name`, `cat_url`, `cat_status`, `cat_addedOn`) VALUES (NULL, '".$this->cat_name."','".$catUrl."', '".$this->status."', '".time()."' )";
	...
	public function update_category(){
        $catUrl = implode("-", $this->cat_name);
		 print_r(implode("-", $this->cat_name));
		echo $query = "update `".$this->rzvy_categories."` set `cat_name`='".$this->cat_name."', `cat_url`='".$catUrl."' where `id`='".$this->id."'";
