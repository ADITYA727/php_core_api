...
class rzvy_login{
	...
	public function login_process(){
       ...
       if($this->loginType == 'client'){
          	...
          	$query = "select * from `".$this->rzvy_customers."` where `email`='".$this->email."' and `password`='".sha1($this->password)."' and `isDeleted`='0'";
       ...
       }elseif($this->loginType == 'shastri'){
           
            /* Check email address and password are correct or not in staff table */

            $query = "select * from `".$this->rzvy_staff."` where `email`='".$this->email."' and `password`='".sha1($this->password)."' and `status`='Y'";
