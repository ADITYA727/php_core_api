=== Rezervy is a great SaaS PHP script for various general requirements of each business. Rezervy provide bundle of features to make it perfect Rezervy. Offline appointment system is like headache, Rezervy will get rid you from this problem. Rezervy is Appointment solution for all businesses. Rezervy helps you to handle Categories-Services-Add-ons, SEO meta tags, Compatible with Strict Mode , Coupon discount, Recurring discounts, Tax/ Vat / GST, Multi-currency supported, One page & StepView Checkout, Easy and smooth Admin panel, Customer panel, Staff panel, Registered and Guest User Checkout, Auto Confirm Appointments, Weekly Schedule, Working & Off days management, Registered and Guest Customers listing with booked appointment details, Payment details, Export all bookings, Customer information , Payment information and services information, Support tickets, feedbacks, Fully Responsive & much more we adding. ===

Contributors: WPMinds Tags: Appointment, Booking, Rezervation, Calendar, Cleaning, Classroom, Spa, Salon, Limpieza reserva, maid booking, Scheduling, Online Appointment Scheduling, Rendez-vous logiciel, reservation system, Doctor
...
Online Booking Software - Appointment solution for your business. 

== Description ==
Rezervy is a great PHP script for various general requirements of each appointment based businesses. Rezervy provide bundle of features to make your work easy and smooth. Rezervy helps you to handle Categories-Services-Add-ons,  SEO meta tags,  Compatible with Strict Mode , Coupon discount, Recurring discounts, Tax/ Vat / GST,  Multi-currency supported, One page Checkout, Easy and smooth Admin panel, Customer dashboard,  Registered and Guest User Checkout,  Auto Confirm Appointments, Weekly Schedule,  Working & Off days management,  Registered and Guest Customers listing with booked appointment details,  Payment details,  Export all bookings, Customer information , Payment information and services information, Support tickets, Fully Responsive & much more we adding. Manage all your required settings at one place and make your website smooth. Rezervy will boost your bussiness with its features. Amazing hmm!! :).
...
== Installation ==
1. Upload the folder in your required directory & Set database credentials in config.php.
2. Run the directory URL in browser.
3. Verify purchase code and configure default company, payment, SMS and email settings.