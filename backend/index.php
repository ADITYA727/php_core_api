...
$company_name = $obj_settings->get_option("IND Spritual");
					...
					<div class="col-md-4 rzvy-login-form-block p-4 m-1">
						...
						<form id="rzvy_login_form" name="rzvy_login_form">
                            <div class="form-group">
                                <label for="rezervy_user_type">Select User</label>
                                <select class="form-control" id="rezervy_user_type" name="rezervy_user_type">
                                <option value="admin">Admin Dashboard</option>
                                <option value="client"> Client Dashboard</option>
                                <option value="shastri">Shastri Dashboard</option>
                                </select>
                            </div>
							<div class="form-group">
