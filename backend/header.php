...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	<title><?php if($rzvy_seo_meta_tag != ""){ echo $rzvy_seo_meta_tag; }else{ echo $obj_settings->get_option("KVT - Admin Dashboard"); } ?></title>
...
<body class="rzvy fixed-nav sticky-footer bg-light" id="rzvy-page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" id="rzvy-mainnav">
     <a class="navbar-brand" href="<?php echo SITE_URL; ?>backend">
	  ...
	  <ul class="navbar-nav navbar-sidenav" id="rzvy-menu-accordion">
		<li class="nav-item <?php if (strpos($_SERVER['SCRIPT_NAME'], 'appointments.php') != false) { echo 'rzy_active'; } ?>">
		  <a class="nav-link" href="<?php echo SITE_URL; ?>backend/appointments.php">
			...
			<span class="nav-link-text"><?php if(isset($rzvy_translangArr['booking'])){ echo $rzvy_translangArr['booking']; }else{ echo $rzvy_defaultlang['booking']; } ?></span>
		  </a>
	...
	<li class="nav-item <?php if (strpos($_SERVER['SCRIPT_NAME'], 'services.php') != false || strpos($_SERVER['SCRIPT_NAME'], 'category.php') != false || strpos($_SERVER['SCRIPT_NAME'], 'addons.php') != false) { echo 'rzy_active'; } ?>">
		  <a class="nav-link" href="<?php echo SITE_URL; ?>backend/category.php">
			...
			<span class="nav-link-text"><?php if(isset($rzvy_translangArr['order'])){ echo $rzvy_translangArr['order']; }else{ echo $rzvy_defaultlang['order']; } ?></span>
		  </a>
		</li>
		<li class="nav-item <?php if (strpos($_SERVER['SCRIPT_NAME'], 'customers.php') != false) { echo 'rzy_active'; } ?>"> 
		 ...
		 <li class="nav-item <?php if (strpos($_SERVER['SCRIPT_NAME'], 'payments.php') != false) { echo 'rzy_active'; } ?>"> 
		  <a class="nav-link" href="<?php echo SITE_URL; ?>backend/payments.php">
			...
			<span class="nav-link-text"><?php if(isset($rzvy_translangArr['shastri'])){ echo $rzvy_translangArr['shastri']; }else{ echo $rzvy_defaultlang['shastri']; } ?></span>
		  </a>
		</li>
		...
		<li class="dropdown nav-item <?php if (strpos($_SERVER['SCRIPT_NAME'], 'schedule.php') != false || strpos($_SERVER['SCRIPT_NAME'], 'manage-blockoff.php') != false) { echo 'rzy_active'; } ?>"> 
		  <a class="nav-link dropdown-toggle" href="#">
			<i class="fa fa-fw fa-calendar"></i>
			<span class="nav-link-text"><?php if(isset($rzvy_translangArr['product'])){ echo $rzvy_translangArr['product']; }else{ echo $rzvy_defaultlang['product']; } ?></span>
		  </a>
		  <ul >
		...
		<li class="nav-item <?php if (strpos($_SERVER['SCRIPT_NAME'], 'location-selector.php') != false) { echo 'rzy_active'; } ?>"> 
		  <a class="nav-link" href="<?php echo SITE_URL; ?>backend/location-selector.php">
			...
			<span class="nav-link-text"><?php if(isset($rzvy_translangArr['staff_permision'])){ echo $rzvy_translangArr['staff_permision']; }else{ echo $rzvy_defaultlang['staff_permision']; } ?></span>
		  </a>
		</li>
		<li class="nav-item dropdown <?php if (strpos($_SERVER['SCRIPT_NAME'], 'refund.php') != false) { echo 'rzy_active'; } ?>"> 
		  <a class="nav-link dropdown-toggle" href="#">
			<i class="fa fa-fw fa-exchange"></i>
			<span class="nav-link-text"><?php if(isset($rzvy_translangArr['cms'])){ echo $rzvy_translangArr['cms']; }else{ echo $rzvy_defaultlang['cms']; } ?></span>
		  </a>
		   <ul >
		...
		<li class="nav-item <?php if (strpos($_SERVER['SCRIPT_NAME'], 'coupons.php') != false) { echo 'rzy_active'; } ?>"> 
		  <a class="nav-link" href="<?php echo SITE_URL; ?>backend/coupons.php">
			...
			<span class="nav-link-text"><?php if(isset($rzvy_translangArr['query'])){ echo $rzvy_translangArr['query']; }else{ echo $rzvy_defaultlang['query']; } ?></span>
		  </a>
		</li>
